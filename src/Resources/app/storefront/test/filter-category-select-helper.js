export default class FilterCategorySelectElement
{
     ...
     liClassList = 'filter-multi-select-list-item filter-property-select-list-item filter-category-select-list-item'
     ...
     labelClassList = 'filter-multi-select-item-label filter-category-select-item-label custom-control-label'
     ...
     childCheckboxClassList = 'custom-control-input filter-multi-select-checkbox filter-category-select-checkbox'
